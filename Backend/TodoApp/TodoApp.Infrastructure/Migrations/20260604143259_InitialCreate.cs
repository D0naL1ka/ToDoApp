    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#FF4B4B", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Червона категорія", null },
                    { 2, "#FF8C00", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Оранжева категорія", null },
                    { 3, "#FFD700", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Жовта категорія", null },
                    { 4, "#4CAF50", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Зелена категорія", null },
                    { 5, "#2196F3", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Синя категорія", null }
                });
